...
function boot(){
  ...
  log('AI Zone Strategist v5 (BOS+Ghost) loaded — tap the AI pill to configure. Master switch is OFF by default; nothing it does affects your trades until you turn it on. If you do not see "v5 (BOS+Ghost)" in this line, your browser is running an old cached copy — the update did not take.');
}
