...
function injectUI(){
  injectStyles();
  const pill=document.createElement('button'); pill.id='aiZonePill'; pill.textContent='🤖 AI v6';
...
function boot(){
  ...
  log('AI Zone Strategist v6 loaded — tap the AI pill (now labeled "AI v6" — check it says v6, not just "AI") to configure. Master switch is OFF by default; nothing it does affects your trades until you turn it on.');
}
